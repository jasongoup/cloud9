...
var ddProjectSelectorRefreshFlag = 0;
...
exports.removeInteractive = function (amlNode) {
   ...
   // var settings = require("core/settings"); 
    var model = ddProjectSelector.getModel(true);
        ...
        function confirm(file) {
            ...
            exports.question(
		     ...
		     var name = file.attributes.name.value;
                    if(name!=null && name!="")
                    for(var i=0;i<model.data.childElementCount;i++){
                                if(model.data.childNodes[i].attributes.name.value===name){
                                        model.data.childNodes[i].remove();
                                        break;
                                }
                    }
