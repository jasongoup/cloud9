...
var config = [
    ...
    // server plugins
    {
        ...
        clientPlugins: [
            ...
            "ext/pkgmgr/pkgmgr", //Add location rule
    ...
    "./cloud9.ide.watcher",
    {
        packagePath: "./cloud9.ide.pkgmgr",
        settingsPath: argv.w + "/.settings"
    },
	{
		packagePath: "./custom.ide.pjbuild",
		settingsPath: argv.w + "/.settings"
	},
   {
                packagePath: "./cloud9.ide.project",
                settingsPath: argv.w + "/.settings"
   }
];
